...
namespace NBT.Core.Services.ApplicationServices.Catalog
{
    public interface ITourService : IService<Tour>
    {
        ...
        IPagedList<TourDto> GetAll(int pageIndex = 1, int pageSize = 20, string filter = "", int stateProvinceId = 0, int countryRegionId = 0,bool? isShow=null, int tourType = 0,int areaId=0);
